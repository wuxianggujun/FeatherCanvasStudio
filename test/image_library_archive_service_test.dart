...
void main() {
  test('exports and imports image library archive with assets and metadata', () async {
    ...
    final exportResult = await const ImageLibraryArchiveService().exportArchive(
      items: sourceItems,
    ...
    final importResult = await const ImageLibraryArchiveService().importArchive(
      store: importStore,
