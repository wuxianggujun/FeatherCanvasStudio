      ...
      child: AlertDialog(
        title: Row(
          children: [
            Expanded(
              child: Text(
                l10n.imageLibrarySliceExplorerTitle(widget.sheet.displayTitle),
              ),
            ),
            if (data != null)
              Text(
                l10n.imageLibrarySliceSavedStatus(
                  savedCount,
                  data.frames.length,
                ),
              ...
              : GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final frameLabel = l10n
                        .imageLibrarySliceExplorerFrameSemanticLabel(
                          index + 1,
                          data.frames.length,
                          saved
                              ? l10n.imageLibrarySliceSavedBadge
                              : l10n.imageLibrarySliceUnsavedStatus,
                        );
                    return Semantics(
                      container: true,
                      label: frameLabel,
                              ...
                              if (!saved)
                                Positioned(
                                  ...
                                  child: Material(
                                    ...
                                    child: IconButton(
                                      tooltip:
                                          l10n.imageLibrarySliceSaveOneTooltip,
                                      iconSize: 20,
        ...
        actions: [
          ...
          FilledButton.icon(
            ...
            label: Text(
              remaining <= 0
                  ? l10n.imageLibrarySliceAllSaved
                  : l10n.imageLibrarySliceSaveAll(remaining),
            ),
          ),
        ],
      ),
